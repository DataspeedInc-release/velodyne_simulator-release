## velodyne_simulator (noetic) - 1.0.13-1

The packages in the `velodyne_simulator` repository were released into the `noetic` distro by running `/usr/bin/bloom-release velodyne_simulator --rosdistro noetic` on `Fri, 02 Dec 2022 18:45:29 -0000`
...
## velodyne_simulator (melodic) - 1.0.13-1

The packages in the `velodyne_simulator` repository were released into the `melodic` distro by running `/usr/bin/bloom-release velodyne_simulator --rosdistro melodic` on `Fri, 02 Dec 2022 18:40:15 -0000`
